...
image_folder_p = 'D:\Biometrics\Probe1\';  % Here Prob1 reffers to folder LG2200-2010-04-27_29 which was supposed to use as Probe 1
...
for ii = 1:numel(N)    %first loop to all the folders inside probe 1
    T = dir(fullfile(image_folder_p,N{ii},'*.tiff')); % In each folder in Probe 1, Taking the tiff files.
...
dirfilename=strcat('D:\Biometrics\','values_2200.xlsx'); 
